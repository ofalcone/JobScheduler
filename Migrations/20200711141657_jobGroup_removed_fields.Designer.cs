...
namespace JobScheduler.Migrations
{
    ...
    [Migration("20200711141657_jobGroup_removed_fields")]
    partial class jobGroup_removed_fields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobScheduler.Models.LaunchResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JobScheduler.Models.NodeLaunchResult", b =>
                {
                    b.Property<int>("NodeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("NodeId", "LaunchResultId");

                    b.HasIndex("LaunchResultId");

                    b.ToTable("NodeLaunchResult");
                });
            ...
            modelBuilder.Entity("JobScheduler.Models.NodeLaunchResult", b =>
                {
                    b.HasOne("JobScheduler.Models.LaunchResult", "LaunchResult")
                        .WithMany("NodeLaunchResults")
